...
public class TruthTable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setAdapter(new ArrayAdapter<>(TruthTable.this, android.R.layout.simple_spinner_dropdown_item, arrayList));
                        ...
                        public void onClick(View v) {
                            if (logicGate.equalsIgnoreCase("AND")){
                                if (!(button1.getText()=="0"&&button2.getText()=="0"&& button3.getText()=="0" &&button4.getText()=="1")){
                                    ...
                                    AlertDialog.Builder builder = new AlertDialog.Builder(TruthTable.this);
